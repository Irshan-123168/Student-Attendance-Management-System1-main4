const API_BASE_URL = 'http://localhost:9036/api';
    ...
    async login(email, password) {
        try {
            ...
            if (isNetworkError(error)) {
                throw new Error('Backend server is unreachable. Please ensure the Spring Boot application is running on port 9035.');
            }
            throw error;
        }
    },
